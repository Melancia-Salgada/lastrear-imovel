...
const opcoesHolerite = [
  { label: "Empréstimo", value: "EMPRESTIMO" },
  { label: "Financiamento", value: "FINANCIAMENTO" },
  { label: "Pensão", value: "PENSAO" },
  { label: "Nenhum", value: "NAO" },
];

export default function DropdownHolerite({ label, valor, onChange }: Props) {
  ...
  const labelSelecionada =
    opcoesHolerite.find((opt) => opt.value === valor)?.label || "Selecione...";
  ...
  return (
    <View style={styles.container}>
      ...
      <Pressable onPress={handleOpenModal} style={styles.selector}>
        <Text style={styles.selectorText}>{labelSelecionada}</Text>
      </Pressable>
      ...
      >
        <Pressable style={styles.modalOverlay} onPress={handleCloseModal}>
          ...
          >
            <Text style={styles.modalTitle}>Selecione o compromisso</Text>
            {opcoesHolerite.map((item) => (
